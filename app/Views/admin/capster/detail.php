        ...
        <div class="page-header mb-4">
            <div class="page-block">
                <ul class="breadcrumb">
                    ...
                    <li class=""><a href="<?= base_url('admin/caspter') ?>">Capster</a></li>
                    <i class="fa fa-angle-right mx-1"></i></li>
            ...
            <div class="card shadow-sm border rounded w-100" style="max-width: 500px;">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center mb-4">
                        <img src="<?= base_url('admin/assets/images/uploads/' . $capster['foto_capster']) ?>"
                            alt="Foto Capster"
                    ...
                    <ul class="list-unstyled text-secondary">
                        <li class="mb-3">
                            Nama Capster:
                            <strong class="text-dark d-block"><?= esc($capster['nama']) ?></strong>
                        </li>
                        <li>
                            Pengalaman:
                            <strong class="text-dark d-block"><?= esc($capster['pengalaman']) ?></strong>
                        </li>
                    </ul>
                </div>
                ...
                <div class="card-footer bg-light px-4 py-3">
                    <div class="flex flex-wrap items-center justify-between w-full">
                        ...
                        <div class="flex gap-2 mt-2 sm:mt-0">
                            <a href="<?= base_url('admin/capster/edit/' . $capster['id']) ?>"
